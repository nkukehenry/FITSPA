...
class Event extends CI_Controller {
	...
	public function index()
	{
		...
		$data['categories']    = events_categories();
	...
	public function view($id=0)
	{
		...
		$data['sessions'] = $this->Model_event->show_event_sessions($data['event_detail']['event_id']);

		$data['id'] = $data['event_detail']['event_id'];
		$data['portfolio_footer'] = $this->Model_portfolio->get_portfolio_data();
		$data['sponsors'] = $this->Model_event->get_event_sponsors($data['id']);
