	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="<?php echo base_url(); ?>admin/dashboard" class="logo">
				<span class="logo-lg">FITSPA</span>
			</a>
  		...
  		<aside class="main-sidebar">
    		<section class="sidebar">
      			...
      			<ul class="sidebar-menu">
			        ...
			        <li class="treeview <?php if( ($class_name == 'counters') ) {echo 'active';} ?>">
			          <a href="<?php echo base_url(); ?>counters">
			            <i class="fa fa-list"></i> <span>Counter Stats</span>
			          </a>
			        </li>

			        <li class="treeview <?php if( ($class_name == 'page') ) {echo 'active';} ?>">
			          <a href="<?php echo base_url(); ?>admin/pages">
			            <i class="fa fa-file-text"></i> <span>Custom Pages</span>
			          </a>
			        </li>
			       
			        <li class="treeview <?php if( ($class_name == 'activities') ) {echo 'active';} ?>">
						<a href="<?php echo base_url(); ?>admin/activities">
			            		<i class="fa fa-circle-o"></i><span>Fitspa Activities</span></a><li>
					</li>
			        <li class="treeview <?php if( ($class_name == 'event') ) {echo 'active';} ?>">
						...
						<ul class="treeview-menu">
							<li><a href="<?php echo base_url(); ?>admin/event">
			            		<i class="fa fa-circle-o"></i>Events</a><li>
						</ul>
					</li>
					<li class="treeview <?php if( ($class_name == 'feature') ) {echo 'active';} ?>">
			          <a href="<?php echo base_url(); ?>admin/publications">
			            <i class="fa fa-cube"></i> <span>Publications</span>
			          </a>
			        </li>
			        ...
			        <li class="treeview <?php if( ($class_name == 'category') || ($class_name == 'news') || ($class_name == 'comment') ) {echo 'active';} ?>">
						...
						<ul class="treeview-menu">
							...
							<li><a href="<?php echo base_url(); ?>admin/news"><i class="fa fa-circle-o"></i> Posts</a></li>
							<li><a href="<?php echo base_url(); ?>admin/comment"><i class="fa fa-circle-o"></i> Comment</a></li>
						</ul>
					</li>
					
					<li class="treeview <?php if( ($class_name == 'subscriber') || ($class_name == 'subscriber') || ($class_name == 'feature') || ($class_name == 'why_choose')  ) {echo 'active';} ?>">
						<a href="#">
						...
						<ul class="treeview-menu">
							...
							<li><a href="<?php echo base_url(); ?>admin/partner"><i class="fa fa-circle-o"></i>Partners</a></li>
							<li><a href="<?php echo base_url(); ?>admin/our-community"><i class="fa fa-circle-o"></i>Our Community</a></li>

							<li><a href="<?php echo base_url(); ?>admin/membership-packages"><i class="fa fa-circle-o"></i>Membership Packages</a></li>

							<li><a href="<?php echo base_url(); ?>admin/encouragement"><i class="fa fa-circle-o"></i>Encouragement</a></li>

							<li><a href="<?php echo base_url(); ?>admin/exhibitions"><i class="fa fa-circle-o"></i>Exhibitions</a></li> 
					...
					<li class="treeview <?php if( ($class_name == 'team_member') ) {echo 'active';} ?>">
						...
						<ul class="treeview-menu">
							...
							<li><a href="<?php echo base_url(); ?>admin/team_member"><i class="fa fa-circle-o"></i>Members</a></li>

							<li><a href="<?php echo base_url(); ?>admin/team_member/committees"><i class="fa fa-circle-o"></i>Committees</a></li>
						</ul>
					</li>
			        ...
			        <li class="treeview <?php if( ($class_name == 'service') ) {echo 'active';} ?>">
			          <a href="<?php echo base_url(); ?>admin/jobs-and-opportunities">
			            <i class="fa fa-life-ring"></i> <span>Jobs & Opportunities</span>
			          </a>
			        </li>
			        ...
			        <li class="treeview <?php if( ($class_name == 'faq') ) {echo 'active';} ?>">
			          <a href="<?php echo base_url(); ?>admin/faq">
			            <i class="fa fa-bolt"></i> <span>Frequently Asked Qns</span>
			          </a>
			        </li>
